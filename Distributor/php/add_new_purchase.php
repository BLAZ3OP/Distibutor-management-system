<?php
  ...
  function isSupplier($name) {  // add new purchase.js on line 55
  ...
  function isInvoiceExist($invoice_number) {  // add new invoice.js on line 164 , add new invoice.php on line 46
    require "db_connection.php";
    if($con) {
  ...
  function isNewMedicine($name, $packing) { // add new purchase.js
    require "db_connection.php";
    if($con) {
  ...
  function addNewPurchase() {  // add new purcahse.js on line 255
    require "db_connection.php";
  ...
  function createMedicineInfoRow() {  // add new invoice.php on line 66
      $row_id = $_GET['row_id'];
