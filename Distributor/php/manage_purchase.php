<?php
  ...
  function showPurchases($id) {  // report.php - 9
    require "db_connection.php";
    if($con) {
      $seq_no = 0;
  ...
  function showPurchaseRow($seq_no, $row) {  // report.php - 49
    ?>
    <tr>
...
function showEditOptionsRow($seq_no, $row) {
  // manage customer.php - 75, manage medicine.php -70, manage medicine stock.php - 80, manage supplier.php -71
  ?>
  <tr>
    <td><?php echo $seq_no; ?></td>
    <td><?php echo $row['VOUCHER_NUMBER'] ?></td>
...
function updatePurchase($id, $suppliers_name, $invoice_date, $grand_total, $payment_status) {  // manage purchase.js - 24
  require "db_connection.php";
  //echo $payment_status;
...
function searchPurchase($text, $column) {  // manage purchase.js - 78
  require "db_connection.php";
  if($con) {
    $seq_no = 0;
