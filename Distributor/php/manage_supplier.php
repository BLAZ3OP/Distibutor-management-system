...
function showEditOptionsRow($seq_no, $row) {
  // manage customer.php - 75, manage medicine stock.php -80, manage purchase.php - 79, manage medicine.php -70
  ?>
  <tr>
    <td><?php echo $seq_no; ?></td>
    <td><?php echo $row['ID'] ?></td>
...
function updateSupplier($id, $name, $email, $contact_number, $address) {  // manage supplier.js - 24
  require "db_connection.php";
...
function searchSupplier($text) {  // manage supplier.js - 56
  require "db_connection.php";
  if($con) {
    $seq_no = 0;
