<?php
  ...
  function searchInvoice($text, $column) {  // manage invoice.js - 24
    require "db_connection.php";
    if($con) {
      $seq_no = 0;
  ...
  function printInvoice($invoice_number) {  // manage invoice.js - 34
    require "db_connection.php";
    if($con) {
      ...
      $doctor_name = $row['CUST_NAME'];
      $doctor_address = $row['CUST_ADDRESS'];
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        <span class="font-weight-bold">Customer Name : </span><?php echo $doctor_name; ?><br>
        <span class="font-weight-bold">Pharmacy Name : </span><?php echo $customer_name; ?><br>
        <span class="font-weight-bold">Pharmacy Address : </span><?php echo $address; ?><br>
        <span class="font-weight-bold">Pharmacy Contact No : </span><?php echo $contact_number; ?><br>
        <!-- <span class="font-weight-bold">Customer Name : </span><?php echo $doctor_name; ?><br> -->
        <!-- <span class="font-weight-bold">Customer Address : </span><?php echo $doctor_address; ?><br> -->
      </div>
      ...
      <div class="col-md-4">
        ...
        <span class="font-weight-bold">Email :<?php echo $p_email; ?></span><br>
