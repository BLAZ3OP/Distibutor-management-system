...
function showEditOptionsRow($seq_no, $row) {
  // manage customer.php - 75, manage medicine stock.php -79, manage purchase.php - 77, manage supplier.php -71
  ?>
  <tr>
    <td><?php echo $seq_no; ?></td>
    <td>
...
function updateMedicine($id, $name, $packing, $generic_name, $suppliers_name) {  // manage medicine.js - 24
  require "db_connection.php";
...
function searchMedicine($text, $tag) {  // manage medicine.js - 57
  require "db_connection.php";
  if($tag == "name")
    $column = "NAME";
  if($tag == "generic_name")
