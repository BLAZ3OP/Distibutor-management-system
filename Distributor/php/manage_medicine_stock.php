...
function showEditOptionsRow($seq_no, $row) {
  // manage customer.php - 75, manage medicine.php -70, manage purchase.php - 77, manage supplier.php -71
  ?>
  ...
  <tr>
    ...
    <td>
      <button href="" class="btn btn-success btn-sm" onclick="updateMedicineStock(<?php echo $row[5]; ?>);">
        <!-- manage medicine stock.js - 24 -->
        <!-- manage medicine stock.php - 124 -->
...
function updateMedicineStock($id, $batch_id, $expiry_date, $quantity, $mrp, $rate) {  // manage medicine stock.js - 67
  require "db_connection.php";
...
function searchMedicineStock($text, $column) {  // manage medicine stock.js - 67
  require "db_connection.php";
  if($con) {
    $seq_no = 0;
