    ...
    <div id="add_new_customer_model">
      <div class="modal-dialog">
      	<div class="modal-content">
            ...
            <div class="font-weight-bold">Add New Pharmacy</div>
        ...
        <div class="row">
          ...
          <div class="row col col-md-12">
            <div class="col col-md-3 form-group">
              <label class="font-weight-bold" for="customers_name">Pharmacy Name :</label>
              <input id="customers_name" type="text" class="form-control" placeholder="Pharmacy Name" name="customers_name" onkeyup="showSuggestions(this.value, 'customer');">
            ...
            <div class="col col-md-3 form-group">
              <label class="font-weight-bold" for="customers_address">Pharmacy Address :</label>
              <input id="customers_address" type="text" class="form-control" name="customers_address" placeholder="Pharmacy Address" disabled>
            </div>
          ...
          <div class="row col col-md-12">
            <div class="col col-md-2 form-group">
              <button class="btn btn-primary form-control" onclick="document.getElementById('add_new_customer_model').style.display = 'block';">New Pharmacy</button>
            </div>
          ...
          <div class="row col col-md-12">
            <div id="save_button" class="col col-md-2 form-group float-right">
              ...
              <!-- add new invoive.js on line 188 -->
            </div>
            ...
            <div id="print_button" class="col col-md-2 form-group float-right" style="display: none;">
              ...
              <!-- manage invoice.js on line 34 -->
              <!-- manage invoice.php on line 75 -->
            </div>
