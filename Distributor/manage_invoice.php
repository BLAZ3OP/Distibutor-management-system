      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-12 form-group form-inline">
            ...
            &emsp;<input type="text" class="form-control" id="by_customer_name" placeholder="By Pharmacy Name" onkeyup="searchInvoice(this.value, 'NAME');">
            ...
            <div class="table-responsive">
                ...
                <tbody id="invoices_div">
                  <?php
                    ...
                    showInvoices();  // manage invoice.php on line 21
                  ?>
                </tbody>
            	</table>
            </div>
