  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="container">
        ...
        <div class="row">
          <div class="row col col-xs-8 col-sm-8 col-md-8 col-lg-8">
            ...
            <?php
              ...
              createSection1('manage_customer.php', 'Total Pharmacy', 'customers');
              ...
              <table class="table table-bordered table-striped table-hover">
                <tbody>
                  ...
                  <tr>
                    <?php
                      $total = 0;
                      $query = "SELECT NET_TOTAL FROM invoices WHERE INVOICE_DATE = '$date'"; //todays report of sales
                      $result = mysqli_query($con, $query);
                  ...
                  <tr>
                    <?php
                      //echo $date;
                      $total = 0;
                      $query = "SELECT TOTAL_AMOUNT FROM purchases WHERE PURCHASE_DATE = '$date'";  //todays report of purchase
                      $result = mysqli_query($con, $query);
                      while($row = mysqli_fetch_array($result))
        ...
        <!-- <div class="row">     dash board extra icons
